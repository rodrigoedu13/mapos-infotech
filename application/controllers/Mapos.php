...
class Mapos extends CI_Controller {
    ...
    public function index() {
        ...
        $this->data['orcamento'] = $this->mapos_model->getOsOrcamentos();
        $this->data['produtos'] = $this->mapos_model->getProdutosMinimo();
        $this->data['produtosEstoque'] = $this->mapos_model->getProdutosComEstoque();
        $this->data['os'] = $this->mapos_model->getOsEstatisticas();
        $this->data['estatisticas_financeiro'] = $this->mapos_model->getEstatisticasFinanceiro();
        $this->data['vendas_mes'] = $this->mapos_model->getEstatisticasVendasMes();
