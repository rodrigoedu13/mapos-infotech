        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
               <?php
                ...
                ?>
                <form action="<?php echo current_url(); ?>" id="formModelo" method="post" class="form-horizontal" >
                     <div class="control-group">
                        <label for="modelo" class="control-label">Modelo<span class="required">*</span></label>
                        <div class="controls">
                            <input id="modelo" class="span4" type="text" name="modelo" value="<?php echo set_value('modelo'); ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        <div class="span12">
                            <div class="span6 offset3">
                                ...
                                <a href="<?php echo base_url() ?>index.php/modelos" id="" class="btn"><i class="icon-arrow-left"></i> Voltar</a>
                            </div>
                        </div>
                    </div>
