                        ...
                        <div class="widget-content tab-content">
                            <div id="tab1" class="tab-pane active">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="nomeCliente" class="span4" type="text" name="nomeCliente" autocomplete="off" value="<?php echo $result->nomeCliente; ?>"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="documento" class="control-label">CPF:</label>
                                    <div class="controls">
                                        <input id="documento" type="text" name="documento" data-mask="000.000.000-00" autocomplete="off" value="<?php echo $result->documento; ?>"  />
                                    </div>
                                </div>
                                <div class="control-group">
