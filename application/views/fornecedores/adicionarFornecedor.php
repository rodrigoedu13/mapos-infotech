                        ...
                        <div class="widget-content tab-content">
                            <div id="tab1" class="tab-pane active">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="nomeFornecedor" class="span4" type="text" name="nomeFornecedor" autocomplete="off" value="<?php echo set_value('nomeFornecedor'); ?>"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="cnpj" class="control-label">CNPJ:</label>
                                    <div class="controls">
                                        <input id="cnpj" type="text"  class="span3" name="cnpj" data-mask="00.000.000/0000-00" autocomplete="off" value="<?php echo set_value('cnpj'); ?>"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="telefone" class="control-label">Inscrição Estadual:</label>
                                    <div class="controls">
                                        <input id="inscricaoE"  class="span3" type="text" name="inscricaoE" autocomplete="off" value="<?php echo set_value('inscricaoE'); ?>"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="telefone" class="control-label">Inscrição Municipal:</label>
                                    <div class="controls">
                                        <input id="inscricaoM"  class="span3" type="text" name="inscricaoM" autocomplete="off" value="<?php echo set_value('inscricaoM'); ?>"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="telefone" class="control-label">Responsavél:</label>
                                    <div class="controls">
                                        <input id="responsavel"  class="span4" type="text" name="responsavel" autocomplete="off" value="<?php echo set_value('responsavel'); ?>"  />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="telefone" class="control-label">Telefone:</label>
                                    <div class="controls">
                                        <input id="telefone"  class="span3" type="text" name="telefone" data-mask="(00)0000-0000" autocomplete="off" value="<?php echo set_value('telefone'); ?>"  />
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="celular"  class="span3" type="text" name="celular" data-mask="(00)00000-0000" autocomplete="off" value="<?php echo set_value('celular'); ?>"  />
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="email" class="span4" type="text" name="email" autocomplete="off" value="<?php echo set_value('email'); ?>"  />
                                    </div>
                                </div>
                            </div>
