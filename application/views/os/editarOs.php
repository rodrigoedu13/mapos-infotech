                            ...
                            <div class="span12" style="padding: 1%; margin-left: 0">
                                <form id="formPagamento" action="" method="post">
                                    ...
                                    <div class="span12 hidden" id="Vparcelado" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span2">
                                            <label for="">&nbsp;</label>
                                            <button class="btn btn-inverse"><i class="icon-white icon-refresh"></i> Gerar</button>
                                        </div>
                                    </div>
                                    <div class="span1">
                                            <label for="">&nbsp;</label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //Funcao para atualizar as parcelas e seus valores https://pt.stackoverflow.com/questions/173406/como-calcular-parcelas-r-e-preencher-inputs/173414
